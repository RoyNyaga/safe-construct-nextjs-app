...
import {
  ...
  Slider, Grid, alpha, IconButton, Pagination,
} from '@mui/material'
        ...
        <Container maxWidth="xl">
          ...
          >
            ...
            <FormControl size="small" sx={{ minWidth: 130 }}>
              ...
              <Select
                id="filter-style"
                labelId="filter-style-label"
                label="Style"
                value={style}
                onChange={(e) => { setStyle(e.target.value); setCurrentPage(1); }}
              >
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 3, maxWidth: 420 }}>
              ...
              <Slider
                ...
                value={areaRange}
                onChange={(_, v) => { setAreaRange(v as [number, number]); setCurrentPage(1); }}
                min={0}
                max={maxArea}
                step={10}
